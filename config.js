...
ALIVE_MSG: process.env.ALIVE_MSG || "HEY DEAR, I'm thrilled to announce that ᴛᴏᴊɪ-ᴍᴅ is ALIVE now—ready to dive into new adventures with you!",
SUDO_NB: process.env.SUDO_NB || "919330416551",
AUTO_REACT: process.env.AUTO_REACT || "true", // Enable/disable auto reaction (true/false)
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
MODE: process.env.MODE || "public",
AUTO_VOICE:"false",
OMDB_API_KEY: "5e339fb7",
OWNER_NAME: process.env.OWNER_NAME || "ᴛᴏᴊɪ-ᴍᴅ",
